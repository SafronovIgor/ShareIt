...
public class ItemController {
    ...
    @PostMapping
    public ItemResponseDto createItem(@RequestHeader(value = Constants.OWNER_USER_ID) Long userId,
    ...
    @PatchMapping("/{itemId}")
    public ItemResponseDto updateItemById(@RequestHeader(value = Constants.OWNER_USER_ID) Long userId,
