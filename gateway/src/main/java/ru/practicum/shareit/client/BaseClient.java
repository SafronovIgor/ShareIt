...
public class BaseClient {
    ...
    public <T> ResponseEntity<Object> post(String path,
                                           Long userId,
    ...
    public <T> ResponseEntity<Object> put(String path,
                                          long userId,
                                          @Nullable Map<String, Object> parameters,
                                          T body) {
    ...
    public <T> ResponseEntity<Object> patch(String path,
                                            Long userId,
                                            @Nullable Map<String, Object> parameters,
                                            T body) {
    ...
    private HttpHeaders defaultHeaders(Long userId) {
        ...
        if (userId != null) {
            headers.set(OWNER_USER_ID, String.valueOf(userId));
        }
        return headers;
    }
}
